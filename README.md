...
* [Homepage](https://github.com/gethomepage/homepage) ⭐ 32,343 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 - A modern, static, self-hosted dashboard offering fast performance, full proxy security, high customization, 100+ service integrations, multiple language translations, and easy configuration via YAML or docker labels.
* [Dashy](https://github.com/Lissy93/dashy) ⭐ 26,353 | 🐛 32 | 🌐 Vue | 📅 2026-09-01 - Feature-rich, self-hosted start page for your browser or homelab.
* [Heimdall](https://github.com/linuxserver/Heimdall) ⭐ 9,309 | 🐛 5 | 🌐 PHP | 📅 2026-08-28 - Server-service based application orientated dashboard.
* [flame](https://github.com/pawelmalak/flame) ⭐ 6,529 | 🐛 175 | 🌐 TypeScript | 📅 2026-06-25 - Its design is inspired (heavily) by SUI. Flame is very easy to setup and use.
* [Organizr](https://github.com/causefx/Organizr) ⭐ 5,814 | 🐛 34 | 🌐 PHP | 📅 2026-05-19 - Organizr allows you to setup "Tabs" that will be loaded all in one webpage.
* [Bento](https://github.com/MiguelRAvila/Bento) ⭐ 2,203 | 🐛 23 | 🌐 JavaScript | 📅 2025-04-21 - Bento is an local/self-hosted tile-based clean startpage.
...
* [Modular Grid Page](https://github.com/timothypholmes/startup-page) ⭐ 526 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-20 - Modular Grid Start Page for your Browser.
...
* [fluidity](https://github.com/PrettyCoffee/fluidity) ⭐ 361 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-27 - Super smooth and stylish startpage. Tuned aesthetic.
...
* [hajimari](https://github.com/toboshii/hajimari) ⭐ 823 | 🐛 67 | 🌐 Go | 📅 2026-08-31 - Hajimari is a beautiful & customizable browser startpage/dashboard with Kubernetes application discovery.
...
* [Modular Startpage](https://github.com/timothypholmes/startup-page) ⭐ 526 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-20 - Grid startpage with many different component panels.
* [re-start](https://github.com/refact0r/re-start) ⭐ 441 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-01 - A TUI-like startpage with weather, Todoist integration, and other features.
...
* [StartOS](https://github.com/Jaredk3nt/startos) ⭐ 66 | 🐛 0 | 🌐 JavaScript | 📅 2020-10-06 - A different take on startpages. StartOS will bring you back the 90s.
